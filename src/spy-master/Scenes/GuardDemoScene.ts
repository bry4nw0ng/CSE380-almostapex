...
export default class GuardDemoScene extends SMScene {
    ...
    protected initializeNPCs(): void {
        ...
        follower1.addPhysics(new AABB(Vec2.ZERO, new Vec2(6, 6)), null, false);
        ...
        follower2.addPhysics(new AABB(Vec2.ZERO, new Vec2(6, 6)), null, false);
