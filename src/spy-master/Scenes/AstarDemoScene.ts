...
export default class AStarDemoScene extends Scene {
    ...
    public startScene(): void {
        ...
        let mapCenter = this.walls.getWorldPosition(midCol, midRow);
        this.viewport.setCenter(mapCenter!.x, mapCenter!.y);
        ...
        this.npc.position.copy(this.walls.getWorldPosition(centerPos.x, centerPos.y)!);
